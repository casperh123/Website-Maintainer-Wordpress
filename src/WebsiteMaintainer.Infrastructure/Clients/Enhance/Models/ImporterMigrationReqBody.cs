...
namespace Enhance.Client.Models
{
    ...
    public partial class ImporterMigrationReqBody : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>The forceQueue property</summary>
        public bool? ForceQueue { get; set; }
        /// <summary>The subscriptionId property</summary>
        public int? SubscriptionId { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Enhance.Client.Models.ImporterMigrationReqBody"/> and sets the default values.
        /// </summary>
        public ImporterMigrationReqBody()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Enhance.Client.Models.ImporterMigrationReqBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Enhance.Client.Models.ImporterMigrationReqBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Enhance.Client.Models.ImporterMigrationReqBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "forceQueue", n => { ForceQueue = n.GetBoolValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteBoolValue("forceQueue", ForceQueue);
