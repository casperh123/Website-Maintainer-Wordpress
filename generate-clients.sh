...
enhance_api_docs_file=".src/EnhanceSiteUpdater.Infrastructure/ApiSpecifications/enhance-api.yaml"
...
dotnet kiota generate -l CSharp -c EnhanceClient -n Enhance.Client -d=./src/EnhanceSiteUpdater.Infrastructure/ApiSpecifications/enhance-api.yaml -o=./src/EnhanceSiteUpdater.Infrastructure/Clients/Enhance --ebc false --co true
